# [Import]
import random, os, time, pickle, tkinter
...
class startupGame:
    ...
    def loadAnimation(self, file):
        ...
        print("\r", file, "Loaded")  # It doesn't remove the | on last frame for some reason but looks kinda cool
...
class battle:
    def battleInitiate(self):
        ...
        while True:
            ...
            if gamePlayer.hp < 1: print("Game Over"); input; exit
